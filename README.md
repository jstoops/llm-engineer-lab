...
- [Expert RAG App AI Agent](https://www.jdscraft.com/img/RAG-App-AI-Agent.jpg): extract data from PDFs and webpages, or [converted to markdown](https://github.com/jstoops/llm-engineer-lab/blob/main/tools/llama-parse.ipynb) for better results, into a vector data store, and automatic local text storage of blog post generated.
